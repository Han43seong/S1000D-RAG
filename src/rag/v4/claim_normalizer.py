...
def normalize_claim_text(text: str) -> list[str]:
    ...
    replacements = [
        ...
        ("the pads press against the rim of the wheel to cause friction", "브레이크 패드가 바퀴의 바깥쪽 림을 누릅니다."),
        ("the wheels lock and the bicycle stops", "수동 시험에서는 브레이크 작동 시 바퀴가 잠기고 자전거가 멈추는지 확인합니다."),
        ("wheels lock and the bicycle stops", "수동 시험에서는 브레이크 작동 시 바퀴가 잠기고 자전거가 멈추는지 확인합니다."),
        ("the wheels must lock and the bicycle must stop", "수동 시험에서는 브레이크 작동 시 바퀴가 잠기고 자전거가 멈추는지 확인합니다."),
