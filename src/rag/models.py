...
def get_embeddings(model_path: str = EMBEDDING_MODEL_PATH) -> Embeddings:
    """HuggingFace BGE-m3-ko 임베딩 싱글턴 반환."""
...
def get_reranker(model_path: str = RERANKER_MODEL_PATH) -> CrossEncoder:
